...
export const SPOTS: Spot[] = [
  ...
  },
  {
    ...
    depth: 0.2,
    actions: ['stare_owner', 'hide_item', 'sniff_flower'],
    base: 0.5,
    serves: 'hunger',
  ...
  },
  {
    ...
    depth: 0.5,
    actions: ['hide_item', 'bury_treasure', 'stretch'],
    base: 0.45,
  ...
  },
  {
    ...
    depth: 0.22,
    actions: ['check_mail', 'peek_window'],
    base: 0.55,
  ...
  },
  {
    ...
    depth: 0.18,
    actions: ['chat_bird', 'sing', 'peek_window'],
    base: 0.6,
